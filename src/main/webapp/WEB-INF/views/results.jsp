...
<body>
	...
	<div class="container-custom">
		...
		<br>
		<p>Starting Location: ${userStuff.state}</p>
		<br>
		<p>Number of Employees: ${userStuff.employees }</p>
		<br>
		<br>
		<h5>Summary</h5>
		<br>
		<p>Ghostbusters of ${userStuff.location }, will be the first
			franchise of the Ghostbusters brand in Michigan. Utilizing existing
			technology, and capturing methods, our goal is to make Michigan a
			more living-person friendly environment.</p>
		<br>
		<br>

		<h5>Description</h5>
		<br>
		<p>Ghostbusters of ${userStuff.location } will provide paranormal
			elimination services to all of Michigan.</P>
		<br>
		<br>

		<h5>Goal</h5>
		<br>
		<p>Using the technology, and methods, developed by the
			Ghostbusters' founders in 1984, this new franchise will provide the
			same reliable and timely service that has been a defining
			characteristic of the Ghostbusters for over 30 years. Services will
			be provided 24/7 at a reasonable price.</p>
		<br>
		<br>
		...
		<p>Total Estimated Annual Revenue: $ ${revenue }</p>
		<br>

		<h5>Profitability</h5>
		<p>The estimated time it will take for the franchise to earn back
			the initial startup cost is: ${profit }</p>
	</div>
	<br>
	<br>
	<a
		href="mailto:?subject=Ghostbuster Calculator Result&body=First Name:%09${userStuff.firstname }%0D%0DLast Name:%09${userStuff.lastname }%0D
		%0D
